...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] =
        LAYOUT(KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_GRV, KC_BSPC,
               ...
               KC_LGUI, KC_LALT, KC_FN2, KC_RALT, KC_RGUI),
     ...
     * |-----------------------------------------------------------------------------------------|
     * |             | CG_TOGG | AG_TOGG |     |     |     |  +  |  -  | End | PgD | Dow |         |     |
     * `-----------------------------------------------------------------------------------------'
     *           |     |        |                                   |        |     |
     *           `-----------------------------------------------------------------'
     * CG_TOGG:toggle Left Contorol and gui
     */
    [HHKB] =
        LAYOUT(KC_PWR, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_INS, KC_DEL,
               ...
               KC_TRNS, CG_TOGG, AG_TOGG, KC_TRNS, KC_TRNS, KC_TRNS, KC_PPLS, KC_PMNS, KC_END, KC_PGDN, KC_DOWN, KC_TRNS, KC_TRNS,
     ...
     * |-----------------------------------------------------------------------------------------|
     * |        | KC_ESC | KC_NO  | End |     |     |     | KC_NO | KC_NO |     | KC_BSPC | KC_NO | KC_NO |  KC_NO   |
     * |-----------------------------------------------------------------------------------------|
     * |          | KC_HOME | Dow | Rig | PgU |     | Lef | Dow | Up  | Rig | KC_ENT |     |            |
     * |-----------------------------------------------------------------------------------------|
     * |             |     | KC_DEL | KC_NO |     | Spc |     | PgU | PgD |     |     |         |     |
     * `-----------------------------------------------------------------------------------------'
     *           |     |        |                                   |        |     |
     *           `-----------------------------------------------------------------'
     */
    [SPACE_FN] =
        LAYOUT(KC_GRV, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_NO, KC_DEL,
               KC_TRNS, KC_ESC, KC_NO, KC_END, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_BSPC, KC_NO, KC_NO, KC_NO,
               KC_TRNS, KC_HOME, KC_DOWN, KC_RGHT, KC_PGUP, KC_NO, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_ENT, KC_NO, KC_TRNS,
               KC_TRNS, KC_NO, KC_DEL, KC_NO, KC_NO, KC_SPC, KC_NO, KC_NO, KC_PGUP, KC_PGDN, KC_NO, KC_TRNS, KC_NO,
               KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
};
